package com.qf.back.v3.consumer.service;

import com.github.pagehelper.PageInfo;
import com.qf.back.v3.consumer.service.fallback.BackServiceHystrix;
...
@FeignClient(value = "back-v3-service",fallback = BackServiceHystrix.class)
public interface IBackService {
    ...
    @RequestMapping("back/selectProductType")
